package com.xenon.utils.renderer.arc;
    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("xenon", "arc_outline"))
                    .withVertexShader(Identifier.of("xenon", "arc_outline_vertex"))
                    .withFragmentShader(Identifier.of("xenon", "arc_outline_fragment"))
