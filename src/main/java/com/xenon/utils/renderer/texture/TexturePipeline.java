package com.xenon.utils.renderer.texture;
    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("xenon", "texture"))
                    .withVertexShader(Identifier.of("xenon", "texture_vertex"))
                    .withFragmentShader(Identifier.of("xenon", "texture_fragment"))
