package com.xenon.utils.renderer.outline;
    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("xenon", "outline"))
                    .withVertexShader(Identifier.of("xenon", "outline_vertex"))
                    .withFragmentShader(Identifier.of("xenon", "outline_fragment"))
