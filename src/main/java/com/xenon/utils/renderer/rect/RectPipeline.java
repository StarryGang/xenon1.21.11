package com.xenon.utils.renderer.rect;
    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("xenon", "rectangle"))
                    .withVertexShader(Identifier.of("xenon", "rectangle_vertex"))
                    .withFragmentShader(Identifier.of("xenon", "rectangle_fragment"))
